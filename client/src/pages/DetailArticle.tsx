...
export const DetailArticle: React.FC<DetailArticleProps> = ({}) => {
  ...
  return (
    <div className="p-8 pt-12 w-full">
      <article className=" w-[60%] mx-auto bg-white rounded-3xl border border-gray-200 shadow-lg">
        ...
        <div className="w-full h-[50vh]">
          <img
            ...
            alt="article image"
            className="w-full max-h-full object-cover shadow-lg"
          />
        </div>
        <p className=" text-justify leading-8 p-8 px-32 text-lg text-gray-600">
          {article?.content}
        </p>
